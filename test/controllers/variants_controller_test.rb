...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { desc: @variant.desc, product_id: @variant.product_id, sku: @variant.sku, title: @variant.title } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { desc: @variant.desc, product_id: @variant.product_id, sku: @variant.sku, title: @variant.title } }
